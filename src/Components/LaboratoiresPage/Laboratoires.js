    ...
    return (
        <div className="laboratories">
            ...
            <Slider ref={sliderRef} {...settings} className="d-flex m100">
                <div className="card card1" style={{ width: "16rem" }}>
                    ...
                    <div className="card-body">
                        ...
                        <Link to="#" className="btn bdpri text-primary">
                            ...
                            <img src={Stroke} alt="icon" />
                        </Link>
                    </div>
                </div>
                <div className="card card1" style={{ width: "16rem" }}>
                    <img src={Image9} className="card-img-top" alt="image" />
                    <div className="card-body">
                        <img className="eyeico" src={Icon7} alt="Image" />
                        <h5 className="card-title">
                           Dr.Mnaser rafik<span><img className="checkm" src={Checkmark} alt="icon" />
                            </span> 
                        </h5>
                ...
                <div className="card card1" style={{ width: "16rem" }}>
                    <img src={Image10} className="card-img-top" alt="icon" />
                    <div className="card-body">
                        <img className="eyeico" src={Icon7} alt="Image" />
                        <h5 className="card-title">
                            Dr. Othmani Salem
                ...
                <div className="card" style={{ width: "16rem" }}>
                    <img src={Image11} className="card-img-top" alt="icon" />
                    <div className="card-body">
                        <img className="eyeico" src={Icon7} alt="Image" />
                        <h5 className="card-title">
                            Dr. Hmidouch Djamel
                ...
                <div className="card card1" style={{ width: "16rem" }}>
                    <img src={Image9} className="card-img-top" alt="Icon" />
                    <div className="card-body">
                        <img className="eyeico" src={Icon7} alt="Image" />
                        <h5 className="card-title">
                           Dr.Mnaser rafik<span><img className="checkm" src={Checkmark} alt="Icon" />
